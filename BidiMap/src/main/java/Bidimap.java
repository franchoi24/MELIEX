...
public class Bidimap {
    ...
    public String parseBits2Morse(Double unit, String bits){
    ...
    public String parseBits2Token(Integer bitsNum, Double unit, char num){
    ...
    public Double findMinInt(String code){
